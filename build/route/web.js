...
var initWebRoutes = function initWebRoutes(app) {
  ...
  router.get('/api/get-extra-infor-doctor-by-id', _doctorController["default"].getExraInforDoctorById);
  ...
  router.post('/api/create-new-specialty', _spcialtyController["default"].createSpecialty);
  router.get('/api/get-specialty', _spcialtyController["default"].getAllSpecialty);
  router.get('/api/get-detail-specialty-by-id', _spcialtyController["default"].getDetailSpecialtyById);
